...
ALTER TABLE
    clientes
ADD
    COLUMN fecha_de_naciemiento DATE NOT NULL;
...
ALTER TABLE
    ingresos_clientes
ADD
    COLUMN historial INT;



INSERT INTO
    ingresos_clientes (fecha_ingreso)
VALUES
(DEFAULT);
...
ADD
   ...
   UPDATE clientes
SET ingresos_id = (SELECT ingresos_id FROM ingresos_clientes WHERE id = 1)
WHERE id = 1;
